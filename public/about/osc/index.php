...
<html>
    <head>
        <?php initialize_page("Obrero Student Council | About | YanoDASH")?>
    ...
    <body>
        ...
        <div class="page-contents no-padding">
            <div class="pch">
                <img class="osc-logo" src="../../images/osc-logo-temporary.png" draggable="false">
                <h1>USeP Obrero Student Council</h1>
            </div>
            ...
            <div class="btn-container">
                <a class="btn" href="../executives/executives.php" style="background: black; color: white">Meet the Executives <span>↗</span></a>
            </div>
            <br><br>
        </div>
