    ...
    <title>OSC Officer Dashboard</title>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    body{font-family:'Gupter',sans-serif;'Robotoflex':var(--bg);color:var(--text)}
...
button:hover {
    ...
    <div class="card div1">
        ...
        <div class="profile">
            ...
            <div class="info">
                <h2>Johnny Bravo <span class="badge">OSC Officer</span></h2>
                <p>📧johnny@usep.edu.ph</p>
                <p>Role: Council Secretary</p>
