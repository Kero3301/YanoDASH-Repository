...
const SOURCES = [
    ...
    'doc_ed' => 'models/DocEd',
    'doc_info' => 'models/DocInfo',
    'user_profile' => 'models/UserProfile',
    'auth_bootstrap' => 'services/auth_bootstrap',
    'user_profile_service' => 'services/user_profile',
    'profile' => 'services/Profile',
    'csrf_token' => 'utils/csrf_token',
    'date_utils' => 'utils/DateUtils',
    'doc_query' => 'services/DocQuery',
    'document_factory' => 'utils/DocumentFactory',
    ...
    'docx_previewer' => 'views/components/docx_previewer',
